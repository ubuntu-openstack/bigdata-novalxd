...
juju run --timeout=120m30s --unit spark/0 "su hdfs -c 'time /usr/bin/spark-submit --class MainRun /tmp/anomaly-detection_2.10-1.0.jar --master yarn > /tmp/spark_job_results.txt'"
echo get results
